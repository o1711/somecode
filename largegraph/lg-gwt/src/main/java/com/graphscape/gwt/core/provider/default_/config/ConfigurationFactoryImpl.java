 ...
 * Sep 21, 2012
 */
package com.graphscape.gwt.core.provider.default_.config;
...
import com.graphscape.gwt.core.consts.UiConstants;
...
public class ConfigurationFactoryImpl extends ContainerAwareUiObjectSupport implements ConfigurationFactoryI {
	 ...
	 * 
	 * @see
	 * com.fs.commons.uicore.api.gwt.client.config.ConfigurationFactoryI#getConfiguration
	 ...
	 * @see
	 * com.fs.commons.uicore.api.gwt.client.config.ConfigurationFactoryI#getConfiguration
	 * (java.lang.String, com.fs.commons.uicore.api.gwt.client.core.UiCallbackI)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.fs.commons.uicore.api.gwt.client.config.ConfigurationFactoryI#
	 * getConfigurationList(java.lang.String[],
	 * com.fs.commons.uicore.api.gwt.client.core.UiCallbackI)
	 */
	@Override
