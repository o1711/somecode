...
public class VerticalTabberLayout extends TabberLayout {
	 ...
	 * 
	 * @see
	 * com.fs.commons.uicommons.impl.gwt.client.widget.tab.TabberLayout#removeTab(com
	...
	/* (non-Javadoc)
	 * @see com.fs.commons.uicommons.impl.gwt.client.widget.tab.TabberLayout#afterTabAddOrRemove()
	 */
	@Override
