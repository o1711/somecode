 ...
 * 
 */
public class AddGraphRequester extends RequesterSupport<GraphI> {
	 ...
	 * @param client
	 */
	public AddGraphRequester(PropertiesI<Object> pts, ClientI lg) {
		super(lg);
		this.pts = pts;
	}
	...
	public MessageI buildRequest() {
		MessageI m2 = new DefaultMessage(null, Path.valueOf("/lg/add-graph"));
