...
public class QingSuanReportCreater implements ReportCreater {
...

	{
		...
		setWeightPercent("结算备付金", 80);
		setWeightPercent("拆出资金", 80);
		setWeightPercent("交易性金融资产", 80);
		setWeightPercent("衍生金融资产", 80);		
		setWeightPercent("应收账款", 80);
		setWeightPercent("预付款项", 80);
		setWeightPercent("应收保费", 80);
		setWeightPercent("应收分保账款", 80);
		setWeightPercent("应收分保合同准备金", 80);
		setWeightPercent("应收利息", 80);
		setWeightPercent("应收股利", 80);
		setWeightPercent("其他应收款", 80);
		setWeightPercent("应收出口退税", 80);
		setWeightPercent("应收补贴款", 80);
		setWeightPercent("应收保证金", 80);
		setWeightPercent("内部应收款", 80);
		setWeightPercent("买入返售金融资产", 80);
